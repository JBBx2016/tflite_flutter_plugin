...
final class TfLiteInterpreter extends Opaque {}

/// Wraps customized interpreter configuration options.
final class TfLiteInterpreterOptions extends Opaque {}

/// Wraps a loaded TensorFlowLite model.
final class TfLiteModel extends Opaque {}

/// Wraps data associated with a graph tensor.
final class TfLiteTensor extends Opaque {}

/// Wraps a TfLiteDelegate
final class TfLiteDelegate extends Opaque {}

/// Wraps Quantization Params
final class TfLiteQuantizationParams extends Struct {
  @Float()
...
final class TFLGpuDelegateOptions extends Struct {
...
final class TfLiteGpuDelegateOptionsV2 extends Struct {
  @Int32()
...
final class TfLiteCoreMlDelegateOptions extends Struct {
  @Int32()
